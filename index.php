...
$con = mysqli_connect("localhost","root","","quiz") or die(mysqli_error($con));
        ...
        if(isset($_POST['submit'])){
          ...
          $enroll_query = "select enroll_no from quiz_marks where enroll_no= '$enroll_no'";
          ...
          if($row2['enroll_no']==$enroll_no){
               ...
               $error_twice_query= "You had already submitted the Quiz!";
          }
              ...
              if ($row['enroll_no']== $enroll_no && $row['password']== $password) {
                        ...
                        header("location: instruction page.php");
                      }
      ...
      <div class="container">
         <div class="navbar-header">
          ...
          <div class="navbar-brand">
            <a href="index.php"><h1>QUIZ PORTAL </h1></a>
            <p>
              <span></span>
            </p>
          </div>
...
<div id="main-content" class="container">
    <div id="portalname"><h1 style="padding-bottom: 10px;">Quiz Portal</h1> </div>
  ...
  <form method="post">
          ...
          <div class="row">
           ...
           <center>
             <b><h3 class="error_login"><?php echo $error_twice_query; ?></h3></b>
